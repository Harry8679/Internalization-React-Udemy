  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md text-black dark:text-white">
      ...
      <form>
        ...
        <input type="text" className="w-full p-2 mb-4 border rounded bg-white dark:bg-gray-700 text-black dark:text-white" placeholder={t('username')} />
        ...
        <button className="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">{t('register')}</button>
      </form>
    </div>
  );
}
